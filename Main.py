...
keyword_llm = HuggingFaceTGIGenerator("mistralai/Mixtral-8x7B-v0.1", token=huggingface_token)
keyword_llm.warm_up()

llm = HuggingFaceTGIGenerator("mistralai/Mixtral-8x7B-v0.1", token=huggingface_token)
llm.warm_up()
